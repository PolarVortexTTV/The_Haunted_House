...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'ghoul' => new CharacterSetting(0, 0, 1.0, true),
		'diablo' => new CharacterSetting(0, 0, 1.0, true),
		'voodoo' => new CharacterSetting(0, 0, 1.0, true)
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		animation.addByPrefix('ghoul', "Pico Idle Dance", 24, false);
